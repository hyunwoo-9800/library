...
<div id="wrap">
    ...
    <div id="container" class="sub">
        ...
        <div class="subTopGroup subType1">
                ...
                <ul class="btnArea clearfix">
                    <li><a href="#snsGroup" id="sns" title="SNS 공유하기" class="snsShare" rel="noopener noreferrer"><span
                        ...
                        <div id="snsGroup" class="snsList clearfix">
                            <a href="#sns2" id="sns2"
                               onclick="javascript:fnShareTwitter('https://www.ptlib.go.kr:443/sglib/menu/10586/contents/40121/contents.do'); return false;"
                               title="트위터에 공유하기" class="snsTwitter" rel="noopener noreferrer"><span
                                    class="blind">트위터</span></a>
                            <a href="#sns1" id="sns1"
                               onclick="javascript:fnShareFaceBook('https://www.ptlib.go.kr:443/sglib/menu/10586/contents/40121/contents.do'); return false;"
            ...
            <h3>이용안내<span class="fn">(시설안내)</span></h3>
        </div>
        <div id="contentcore">
            <div id="contents" class="contentArea">
                ...
                <div class="tabNav" style="display: block;">
                    ...
                    <ul class="tnb clearfix">
                        ...
                        <li class="choiced" style="min-width: 299.75px;"><a
                                href="/libraryInfo/howToUse3" rel="noopener noreferrer"
                                class="current">시설안내</a></li>
                ...
                <ul class="theme-list">
                    <li>
                        <h4 class="htitle">1층 시청각실</h4>
                        <img alt="1층 시청각실 사진" src="/images/img_facil01.gif">
                        <ul class="dot-list">
                            <li>좌석수 : 60</li>
                            <li>운영내용 : 영화상영, 프로그램운영</li>
                        </ul>
                    </li>
                    <li>
                        <h4 class="htitle">1층 문화강좌실</h4>
                        <img alt="1층 문화강좌실 사진" src="/images/img_facil02.gif">
                        <ul class="dot-list">
                            <li>좌석수 : 10</li>
                            <li>운영내용 : 소모임, 강좌운영</li>
                        </ul>
                    ...
                    <li>
                        <h4 class="htitle">1층 어린이자료실</h4>
                        <img alt="1층 어린이자료실 사진" src="/images/img_facil03.gif">
                        <ul class="dot-list">
                            <li>이용대상 : 유아~초등학생</li>
                            <li>이용안내 : 유아·아동도서, 영어도서&nbsp;비치, PC이용, 화장실</li>
                            <li>장서현황 : 14,525권</li>
                        </ul>
                    </li>
                    <li>
                        <h4 class="htitle">도토리방(영유아방)</h4>
                        <img alt="도토리방(영유아방) 사진" src="/images/img_facil04.gif">
                        <ul class="dot-list">
                            <li>이용대상 : 영아~유아</li>
                            <li>이용안내 : 아기도서 및 영어보드북&nbsp;비치</li>
                        </ul>
                    </li>
                    <li>
                        <h4 class="htitle">2층 종합자료실</h4>
                        <img alt="2층 종합자료실 사진" src="/images/img_facil05.gif">
                        <ul class="dot-list">
                            <li>이용대상 : 청소년~성인</li>
                            <li>이용안내 : 일반도서, 영어도서, 청소년도서, 연속간행물 등 비치</li>
                            <li>장서현황 : 15,685권</li>
                        </ul>
                    </li>
                    <li>
                        <h4 class="htitle">컴퓨터 이용(1,2층 자료실) 및 복사기 사용(2층 자료실), 독서보조기기 코너(2층 자료실)</h4>
                        <img alt="컴퓨터이용(1,2층 자료실) 사진" src="/images/img_facil06.gif">
                        <ul class="dot-list">
                            <li>이용안내 : 인터넷 정보검색, DVD 감상, 문서편집가능</li>
                            <li>이용시간 : 1인당 2시간</li>
                            <li>프린트 출력 및 복사: 1층 대출대에서 카드 판매,&nbsp;단 현금으로만 구매 가능(3,000원), 흑백 A4만 가능</li>
                            <li>독서보조기기 : 문자인식음성출력기, 휴대용 독서확대기, 전동높낮이조절책상, 공공이용보청기</li>
                        </ul>
                    </li>
                </ul>
