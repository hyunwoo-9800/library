...
<div id="wrap">
  ...
  <header id="header">
    ...
    <div class="headerInner clearfix">
      ...
      <div id="siteMenu" class="siteMenu clearfix">
        ...
        <ul>
          ...
          <li class="logout"><a href="/intro/memberLogout.do" rel="noopener noreferrer">로그아웃</a></li>
          <li class="mypage mobileHide2"><a href="/intro/memberModify.do" rel="noopener noreferrer">정보수정</a></li>
      ...
      <a href="/sglib/mypage.do" id="mobileMembership" class="mobileShow" rel="noopener noreferrer"><span class="blind">모바일회원증 바로가기</span></a>
    ...
    <nav id="gnbNavM">
      ...
      <ul id="gnbM" class="clearfix" style="overflow: hidden;">
        ...
        <li id="gnb2" class=""><a href="#link" rel="noopener noreferrer" data-href="/sglib/menu/11108/program/30015/plusSearchSimple.do" class="link">자료찾기</a>
          <ul style="display: none;">
        ...
        <li id="gnb3" class=""><a href="#link" rel="noopener noreferrer" data-href="/sglib/menu/10609/program/30025/lectureList.do" class="link">운영프로그램</a>
          <ul style="display: none;">
        ...
        <li id="gnb4" class=""><a href="#link" rel="noopener noreferrer" data-href="/sglib/menu/10618/bbs/20003/bbsPostList.do" class="link">참여마당</a>
          <ul style="display: none;">
        ...
        <li id="gnb5" class="fbC"><a href="#link" rel="noopener noreferrer" class="current link" data-href="/sglib/menu/10623/program/30030/mypage/myInfo.do">내서재</a>
          <ul style="display: none;">
            <li id="gnb5_1"><a href="/sglib/menu/10623/program/30030/mypage/myInfo.do" rel="noopener noreferrer" class="current">기본정보</a> </li>
  ...
  <div id="container" class="sub">
    ...
    <div class="subTopGroup subType5">
      <h2 class="blind">내서재</h2>
      ...
      <div class="navGroup mobileHide">
        <div id="lnb" class="navArea clearfix">
          ...
          <div class="navSelBox"><a href="javascript:;" class="btnSel">내서재</a><ul><li><a href="/sglib/menu/10580/contents/40117/contents.do" rel="noopener noreferrer">도서관소개</a></li>
            ...
            <li><a href="/sglib/menu/10623/program/30030/mypage/myInfo.do" rel="noopener noreferrer" class="current">내서재</a></li>
          ...
          </ul></div><div class="navSelBox"><a href="javascript:;" class="btnSel">기본정보</a><ul><li><a href="/sglib/menu/10623/program/30030/mypage/myInfo.do" rel="noopener noreferrer" class="current">기본정보</a></li>
          <li><a href="/sglib/menu/10626/program/30032/mypage/loanStatusList.do" rel="noopener noreferrer">대출조회/반납연기</a></li>
          <li><a href="/sglib/menu/10625/program/30031/mypage/reservationStatusList.do" rel="noopener noreferrer">예약현황조회</a></li>
          <li><a href="/sglib/menu/10629/program/30034/hopeBookWrite.do" rel="noopener noreferrer">희망도서신청</a></li>
          <li><a href="/sglib/menu/10631/program/30035/mypage/basketList.do" rel="noopener noreferrer">관심도서조회</a></li>
          <li><a href="/sglib/menu/10633/program/30036/mypage/libraryOneLillStatusList.do" rel="noopener noreferrer">책이음상호대차조회</a></li>
          <li><a href="/sglib/menu/10636/program/30025/mypage/lectureApplyList.do" rel="noopener noreferrer">신청내역(프로그램·시설대관)</a></li>
          <li><a href="/sglib/menu/10639/program/30046/mypage/myPopularBookList.do" rel="noopener noreferrer">도서추천서비스</a></li>
        </ul></div></div>
      </div>
      <div class="snsFarm">
        <ul class="btnArea clearfix">
          <li><a href="#snsGroup" id="sns" title="SNS 공유하기" class="snsShare" rel="noopener noreferrer"><span class="blind">SNS 공유하기</span></a>
            <div id="snsGroup" class="snsList clearfix">
              <a href="#sns2" id="sns2" onclick="javascript:fnShareTwitter('https://www.ptlib.go.kr:443/sglib/menu/10623/program/30030/mypage/myInfo.do'); return false;" title="트위터에 공유하기" class="snsTwitter" rel="noopener noreferrer"><span class="blind">트위터</span></a>
              <a href="#sns1" id="sns1" onclick="javascript:fnShareFaceBook('https://www.ptlib.go.kr:443/sglib/menu/10623/program/30030/mypage/myInfo.do'); return false;" title="페이스북에 공유하기" class="snsFacebook" rel="noopener noreferrer"><span class="blind">페이스북</span></a>
            </div>
          </li>
    ...
    <div id="contentcore">
      <div id="contents" class="contentArea">
        ...
        <div class="myPageWrap">
          <div class="clearfix">
            <div class="myInfoBox mobileHide2">
              <div class="title themeBG"><strong class="name themeFC">조현우</strong>님, 반갑습니다.</div>
              <a href="/intro/memberModify.do" title="새창에서열림" target="_self" class="btnModiry btn small white" rel="noopener noreferrer">개인정보수정</a>
              <div class="myInfo">
                <div class="memType">
                  ...
                  <strong class="member typeA themeColor">정회원<br><span>책이음회원</span></strong>
                ...
                <div class="myInfoList">
                  <ul class="dot-list">
                    <li>아이디 : himatubusiyon <span class="emp1"></span></li>
                    <li>회원가입일 : 2009-04-01</li>
                    <li>휴대폰번호 : 010-5***-9800
                      (SMS수신)
                      <a href="/intro/memberModify.do" class="btn small white" rel="noopener noreferrer">휴대폰정보 변경</a>
                    </li>
                    <li>이메일주소 : hi******@naver.com
                      (이메일수신)
                      <a href="/intro/memberModify.do" class="btn small white" rel="noopener noreferrer">이메일주소 변경</a>
                    </li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="myInfoBox mobileShow2">


              <div class="title themeBG">
                <strong class="name themeFC">조현우</strong>님, 반갑습니다.
              ...
              <div class="membership">
                <ul class="dot-list">
                  <li>아이디 : himatubusiyon <span class="emp1"></span></li>
                  <li>회원번호 : 14103115005040</li>
                </ul>
                <div class="barcode">
                  <img src="/cmmn/barcode/getBarCode.do?width=248&amp;height=75&amp;data=14103115005040" width="248" height="75" alt="14103115005040">
                </div>
              </div>
            ...
            <h4 class="htitle mobileShow">서비스 이용현황</h4>
            <ul class="myState clearfix">

              <li>
                <div>
                  <strong class="tit">대출중인 <br>도서수</strong>
                  <a href="/sglib/loanStatusList.do" class="num overdue" rel="noopener noreferrer">0</a>
                </div>
              </li>
              ...
              <li>
                <div>
                  ...
                  <a href="/sglib/reservationStatusList.do" class="num" rel="noopener noreferrer">0</a>
                </div>
              </li>
              ...
              <li>
                <div>
                  <strong class="tit">신청중인 <br>희망도서수</strong>
                  <a href="/sglib/hopeBookList.do" class="num" rel="noopener noreferrer">0</a>
                </div>
              </li>
              ...
              <li>
                <div>
                  <strong class="tit">신청중인 <br>프로그램수</strong>
                  <a href="/sglib/lectureApplyList.do" class="num" rel="noopener noreferrer">0</a>
                </div>
              </li>
            </ul>
          </div>
          <h4 class="htitle">메뉴 바로가기</h4>
          <ul class="menuShortcut clearfix">

            <li>
              <a href="/sglib/loanStatusList.do" rel="noopener noreferrer">
                <strong class="tit">도서대출정보</strong>
                <span class="txt">나의 도서 대출현황, 예약현황 및 대출이력을 조회할 수 있습니다.</span>
              </a>
            </li>

            <li>
              <a href="/sglib/libraryOneLillStatusList.do" rel="noopener noreferrer">
                <strong class="tit">책이음 현황 조회</strong>
                <span class="txt">내가 신청한 책이음  현황을 확인할 수 있습니다.</span>
              </a>
            </li>


            <li>
              <a href="/sglib/basketList.do" rel="noopener noreferrer">
                <strong class="tit">관심자료보기</strong>
                <span class="txt">내가 등록한 관심도서 정보를 확인할 수 있습니다.</span>
              </a>
            </li>


            <li>
              <a href="/sglib/hopeBookList.do" rel="noopener noreferrer">
                <strong class="tit">희망도서 신청조회</strong>
                <span class="txt">내가 신청한 희망도서신청현황을 확인할 수 있습니다.</span>
              </a>
            </li>


            <li>
              <a href="/sglib/lectureApplyList.do" rel="noopener noreferrer">
                <strong class="tit">프로그램 신청조회</strong>
                <span class="txt">내가 신청한 프로그램 신청현황을 확인할 수 있습니다.</span>
              </a>
            </li>

            <li>
              <a href="/sglib/newFacilityApplyList.do" rel="noopener noreferrer">
                <strong class="tit">시설대관조회</strong>
                <span class="txt">내가 신청한 시설대관 신청 현황을 확인할 수 있습니다.</span>
              </a>
            </li>
          </ul>
        </div>
